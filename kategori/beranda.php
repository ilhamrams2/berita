...
<?php foreach ($query as $data): ?>
	...
	<div class="col-lg-4 mt-3 article p-2">
		<a href="index.php?page=detail&id=<?= $data['id_post'] ?>" style="text-decoration: none;" >
			<div class="card">
				<div class="card-top">
					<img src="assets/file/post/<?= $data['img'] ?>" alt="" class="img-thumbnail">
				</div>
				<div class="card-body px-3 pt-0 py-2" style="background-color: white;">
					<div class="information py-2">
						<span class="ion-calendar"> <?= $data['date'] ?> | </span>
						<span class="ion-person m-0"> <?= $data['author'] ?> </span>
					</div>
					<h3 class="text-primary"><?= $data['judul'] ?></h3>
				</div>
			</div>
		</a>
	</div>
